...
window.addEventListener("load", function() {
    // Getting the favourites array from localStorage
    ...
    if (favourites == null) {
        cardContainer.innerHTML = "<span style='color:red;'><p class=\"no-characters\">No characters present in Favourites</p> </span>"
        return;
    }
